...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/pds.env)")
}
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".pdsadmin" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigType("env")
		viper.SetConfigName("pds")
	}
